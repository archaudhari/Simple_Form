...
function Edit() {
	...
	useEffect(() => {
        setname(localStorage.getItem('Gender'))
        setname(localStorage.getItem('DOB'))
	...
	<div>
		<Form className="d-grid gap-2" style={{margin:'15rem'}}>
            ...
            <Form.Group className="mb-3" controlId="formBasicName">
	            <Form.Control value={DOB}
                 onChange={e => setname(e.target.value)}
                 type="date"placeholder="date" required/>
            </Form.Group>

            <Form.Group className="mb-3" controlId="formBasicName">
            <select name="gender" id="gender" class="form-control" placeholder='Gender' value={Gender}>
